...
public class Dog implements Serializable {
    ...
    static final File DOG_FOLDER = CapersRepository.DOGS_DIR;
    ...
    public static Dog fromFile(String name) {
        ...
        if (!dogFile.exists()) {
            System.err.println("Dog " + name + " does not exist!");
            return null;
        }
...
//        if (dogFile.exists()) {
//            System.err.println("A dog by the name of " + this.name + " already exists!");
//            return;
//        }
